      ...
      <div className="card grid" style={{ maxWidth: 1000, margin: '0 auto', gap: 18 }}>
        ...
        <div className="grid grid-2" style={{ alignItems: 'start' }}>
          ...
          <form className="card grid" style={{ boxShadow: 'none' }} onSubmit={saveTemplate}>
            ...
            <p className="muted">Available fields: {'{merchant}'}, {'{merchant_phone}'}, {'{merchant_email}'}, {'{merchant_address}'}, {'{merchant_bank}'}, {'{merchant_bsb}'}, {'{merchant_account}'}, {'{customer_name}'}, {'{order_number}'}, {'{salesperson}'}, {'{mobile}'}, {'{balance_payable}'}, {'{payment_status}'}, {'{order_status}'}, {'{stripe_checkout_url}'}, {'{street_address}'}, {'{suburb}'}, {'{state}'}, {'{postcode}'}, {'{address}'}, {'{goods_in_date}'}, {'{ready_after_date}'}, {'{delivery_date}'}</p>
