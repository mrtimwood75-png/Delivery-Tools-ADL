...
// Dashboard SMS templates editor — the named notification/automation templates
// (order/delivery messages, the payment-received SMS, etc.). Shared by the
// standalone /templates page and the Admin "SMS Templates" tab so both edit the
// same thing.
...
export default function SmsTemplatesEditor() {
  ...
  // Drag-and-drop reordering. Reorder the local list optimistically as the user
  // drags, then persist the final order on drop.
